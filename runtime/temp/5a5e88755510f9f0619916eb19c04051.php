<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"../application/template/default/index\mycenter\article_list.html";i:1487565884;s:54:"../application/template/default/index\base\common.html";i:1487565884;s:55:"../application/template/default/index\mycenter\nav.html";i:1487565884;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="UTF-8">
...
<div class="rightcon sizing"><!-- 右边内容 -->
    ...
    <div class="publicdiv bf">
        ...
        <h3 class="pt10 pb10 pl20 pr20 fs16 sizing iconfont">&#xe704; 我的文档</h3>
            ...
            <table class="table table-striped borl bort borr borb">
                ...
                <tbody>
                    ...
                    <tr id="projectlist">
                        ...
                        <td class="ac iconfont"><a href="<?php echo url('/index/article/add?id='.$article['id']); ?>" class="btn-link">&#xe71d;</a></td>
                    </tr>
                    <?php endforeach; ?>
                    <?php echo $page; ?>
                </tbody>
