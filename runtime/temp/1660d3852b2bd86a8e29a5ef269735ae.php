<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"../application/template/default/admin\user\lists.html";i:1487646908;s:54:"../application/template/default/admin\base\common.html";i:1487645348;s:56:"../application/template/default/admin\base\left_nav.html";i:1487645348;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="UTF-8">
        ...
        <table class="table">
          ...
          <?php foreach($user_list as $user): ?>
              <tr>
                ...
                <td><a href="<?php echo url('/admin/user/detail'); ?>" class="text-primary" target="_bacnk"><?php echo $user['realname']; ?></a></td>
