<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"../application/template/default/index\mycenter\weburl_list.html";i:1487242913;s:54:"../application/template/default/index\base\common.html";i:1487565884;s:55:"../application/template/default/index\mycenter\nav.html";i:1487565884;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="UTF-8">
...
<div class="rightcon sizing"><!-- 右边内容 -->
    ...
    <div class="publicdiv bf">
        ...
        <h3 class="pt10 pb10 pl20 pr20 fs16 sizing iconfont">&#xe60e; 我的收藏</h3>
        
        <div class="publicdiv pl20 pr20 pt8 pb8 bf sizing">
            <table class="table table-striped borl bort borr borb">
                <thead style="background:#f1f1f1;">
                    <tr>
                        <th class=""><a href="<?php echo url('/index/project/lists'); ?>">标题</a></th>
                        <th class="">链接</th>
                        <th class="ac">所属项目</th>
                        <th class="ac">备注</th>
                        <th class="ac">状态</th>
                ...
                <tbody>
                    ...
                    <tr id="projectlist">
                        ...
                        <td class="ac iconfont"><a href="<?php echo url('/index/weburl/add/?id='.$weburl['id']); ?>" class="btn-link">&#xe71d;</a></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
