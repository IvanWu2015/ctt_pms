        ...
        <div class="publicdiv borb mb20 pt10 pb10 bf sizing">
            ...
            <ul class="nav nav-pills">
                ...
                <span class="pull-right">
                    <a href="<?php echo url('add'); ?>" class="btn btn-info">添加项目</a> 
                </span>
            </ul>
        </div>
            ...
            <section id="contents" class="mtn">
                <table class="table table-striped borl bort borr borb">
                    <thead style="background:#f1f1f1;">
                        <tr>
                            <th class=""><a href="<?php echo url('/index/project/lists'); ?>">项目名称</a></th>
                            <th class="ac"><a href="<?php echo url('/index/project/lists/?orderby=date&id='.$project_id); ?>">结束日期</a></th>
                            <th class="ac">状态</th>
                            <th class="ac"><a href="<?php echo url('/index/project/lists/?orderby=all_time&id='.$project_id); ?>">总预计</a></th>
                            <th class="ac"><a href="<?php echo url('/index/project/lists/?orderby=consumed_count&id='.$project_id); ?>">总消耗</a></th>
                            <th class="ac"><a href="<?php echo url('/index/project/lists/?orderby=percent&id='.$project_id); ?>">进度</a></th>
                            <th class="ac">操作</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr id="projectlist">
                            <td><a href="<?php echo url('/index/project/detail/?id='.$project['id']); ?>"><?php echo $project['name']; ?></a></td>
                            <td class="ac"><?php echo $project['end']; ?></td>
                            <td class="ac">
                                <?php if($project['status'] == 'wait'): ?><span style="color:#f8b004;">等待</span><?php endif; if($project['status'] == 'done'): ?><span style="color:green;">完成</span><?php endif; if($project['status'] == 'doing'): ?><span style="color:blue;">进行中</span><?php endif; if($project['status'] == 'closed'): ?><span style="color:grey;">关闭</span><?php endif; ?>
                            </td>
                            <td class="ac"><?php echo $project['all_time']; ?></td>
                            <td class="ac"><?php echo $project['estimate_count']; ?></td>
                            <td class="ac" title="当前进度：<?php echo $project['percent']; ?>%">
                                <div class="progress hp10 mt5">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $project['percent']; ?>%; background:<?php if($project["percent"] == 100): ?>#28dd2c<?php elseif($project["percent"] > 50): ?>#5bc0de<?php endif; ?>;">
                                        <span class="sr-only"><?php echo $project['percent']; ?></span>
                                    </div>
                                </div>
                            </td>
                            <td class="ac iconfont"><a href="<?php echo url('/index/project/add/?project_id='.$project['id']); ?>" class="btn-link">&#xe71d;</a></td>
                        </tr>
                        <?php endforeach; ?>
