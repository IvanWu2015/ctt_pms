<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"../application/template/default/index\article\add.html";i:1487565884;s:54:"../application/template/default/index\base\common.html";i:1487565884;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="UTF-8">
...
<div class="publicdiv pl20 pr20 pt8 bf sizing">
    ...
    <form action="<?php echo url('/index/article/add?id='.$article_detail['id']); ?>" method="post" class="form-horizontal" role="form">
        <h3 class="ac">添加文档</h3>
            <div class="modal-body">
                ...
                <div class="form-group w100 mrn mln z">
                    ...
                    <div class="col-sm-10 pln prn" style="width:910px;">
                        <input type="text" name="title" class="form-control" id="name" placeholder="请输入任务名称" value="<?php echo $article_detail['title']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group w100 mrn mln z">
                    ...
                    <div class="col-sm-10 pln prn" style="width:910px;">
                        <select name="class_id" class="form-control">
                            ...
                            <?php foreach($sort_list as $temp_sort): ?>
                            <option <?php if($temp_sort['id'] == $article_detail['class']): ?>selected='selected'<?php endif; ?> value="<?php echo $temp_sort['id']; ?>" ><?php echo $temp_sort['name']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group w100 mrn mln z">
                    ...
                    <div class="col-sm-10 pln prn" style="width:910px;">
                        <select name="project_id" class="form-control">
                            ...
                            <option <?php if($temp_project['id'] == $article_detail['project']): ?>selected='selected'<?php endif; ?> value="<?php echo $temp_project['id']; ?>" ><?php echo $temp_project['name']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                <div class="form-group w100 mrn mln z">
                    ...
                    <div class="col-sm-10 pln prn" style="width:910px;">
                        <label><input type="radio" name="acl" value="open" <?php if($article_detail['acl'] == 'open'): ?>checked='checked'<?php endif; ?> >公开</label>
                        <label><input type="radio" name="acl" value="private" <?php if($article_detail['acl'] == 'private'): ?>checked='checked'<?php endif; ?> >私有</label>
                    </div>
                </div>
                ...
                <div class="form-group z">
                    ...
                    <div class="col-sm-10 pln" style="width:922px;">
                        ...
                        <script id="editor" type="text/plain" class="z" name="contents" style="width:100% !important; height:350px;"><?php echo $article_detail['contents']; ?></script>
                    </div>
                </div>
