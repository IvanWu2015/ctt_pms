<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:57:"../application/template/default/index\project\action.html";i:1486714305;s:54:"../application/template/default/index\base\common.html";i:1487558202;s:61:"../application/template/default/index\base\project_title.html";i:1486628798;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="UTF-8">
    ...
    <div class="navbar-inner">
        ...
        <div class="publicdiv pl20 pr20 sizing">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="mt20 mb10 ml20"><a class="active" href="<?php echo url('index/index'); ?>">首页</a></li>
				...
				<li class="mt20 mb10"><a href="<?php echo url('/index/mycenter'); ?>">个人中心</a></li>
...
<div class="publicdiv  pt10 pb10 ptn sizing">
    ...
    <div class="publicdiv pl20 pr20 pt8 pb20 bf sizing">
            ...
            <section id="contents" class="mtn">
                <table class="table table-striped borl bort borr borb">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="ac"><?php echo $project['id']; ?></td>
                            <td class="">
        ...
        <div class="publicdiv ac pagingw"></div>
    </div>
</div>
